...
export default function Jirai(props) {
            ...
            "contents": [
                {
                    ...
                    "body": {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": "https://s4.aconvert.com/convert/p3r68-cdx67/aew67-6unu2.jpg",
                                "size": "full",
                                "aspectMode": "cover",
                                "aspectRatio": "1:1",
                                "gravity": "center"
                ...
                },
                {
                    ...
                    "body": {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": "https://bnewg.up.seesaa.net/image/b781ac682028129.jpg",
                                "size": "full",
                                "aspectMode": "cover",
                                "aspectRatio": "1:1",
                                "gravity": "center"
                ...
                },
                {
                    ...
                    "body": {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": "https://p.potaufeu.asahi.com/ef39-p/picture/26839911/a41f92c90ba541a370211ec00176364e.png",
                                "size": "full",
                                "aspectMode": "cover",
                                "aspectRatio": "1:1",
                                "gravity": "center"
                ...
                },
                {
                    ...
                    "body": {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": "https://www.asunaro-kk.com/wp/wp-content/uploads/2019/01/hikikomori_toukoukyohi.png",
                                "size": "full",
                                "aspectMode": "cover",
                                "aspectRatio": "1:1",
                                "gravity": "center"
    ...
    if (closeOK) {
        ...
        alert("送信しました Debug: " + liff.sendMessages(msg));
    }else {
        alert("本当に閉じますか？");
        liff.closeWindow();
    }
