...
export default function SearchContent() {
  ...
  return (
    <>
      ...
      {showDetail ? (
        <div className="fixed text-white top-0 w-[90%] max-w-[315px] h-[90vh] mt-[80px] bg-gray-600 rounded-lg shadow-sm shadow-gray-500 flex flex-col items-center justify-around">
          <button
